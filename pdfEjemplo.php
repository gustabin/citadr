    ...
    <div class="container">
      <div class="row">
        <div class="span5 offset1">
          <img alt="" src="<?php echo INCLUDES ?>img/ipad.png">
        </div>
        <div class="span5 _offset1">
          <div class="slogan">
            ...
            <p>
			  ...
			  <a class="btn btn-large btn-primary" href="excel.php">Excel</a>
			  <a class="btn btn-large btn-primary" href="pdf.php">PDF</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="span3">
          <h2 class="section-title">
            Sin esperas
            <small>cita rápida y fàcil</small>
          </h2>
          <p>
          ...
          <div class="row">
            <div class="span3">
              <div class="text-center">
				...
				<h4>				
                  <a href="javascript:void(0)" class="hipervinculo">Sin madrugar</a>
                </h4>
            ...
            <div class="span3">
              <div class="text-center">
                ...
                <h4>
                  <a href="javascript:void(0)" class="hipervinculo">Para todos</a>
                </h4>
            ...
            <div class="span3">
              <div class="text-center">
                ...
                <h4>
                  <a href="javascript:void(0)" class="hipervinculo">Haz una cita Online</a>
                </h4>
                <p>Aqui puedes buscar un doctor cercano a tu localidad de acuerdo a la especialidad.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="span3">
          <blockquote>
            <p>
              <i class="icon-quote-left icon-4x pull-left icon-muted"></i>
              Como médico me siento mucho más tranquilo en saber quienes son los pacientes que asisten a mi consulta, hoy estoy mas seguro porque uso citadr.com y no me canso de recomendarlo a mis colegas.
            </p>
            ...
            <div class="carousel carousel-mini slide" data-pause="true" id="myCarouselNews">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <div class="span3">
                    <figure>
                        <img alt="" src="<?php echo INCLUDES ?>img/gallery/01rct-s.jpg">
                    </figure>
                    <h4>
                      <font color="#1C7CA2">Desde tu laptop</font>
                    </h4>
                    <p>No se trata de un directorio médico, aqui puedes encontrar un doctor cercano a tu localidad de acuerdo a la especialidad, con tan solo unos cuantos clicks en tu laptop.</p>                    
                  </div>
                  <div class="span3">
                    <figure>
						<img alt="" src="<?php echo INCLUDES ?>img/gallery/02rct-s.jpg">
                    </figure>
                    <h4>
                  ...
                  <div class="span3">
                    <figure>
						<img alt="" src="<?php echo INCLUDES ?>img/gallery/03rct-s.jpg">
                    </figure>
                    <h4>
						<font color="#1C7CA2">Desde la tablet</font>
                    </h4>
                    <p>Si prefieres la libertad que brinda la tecnología entonces citadr es para ti, revisa tus citas, fecha, hora, historia médica, inclusive el motivo de las visitas.</p>                    
                  </div>
                </div>
                <div class="item">
                  <div class="span3">
                    <figure>
						<img alt="" src="<?php echo INCLUDES ?>img/gallery/04rct-s.jpg">
                    </figure>
                    <h4>
                  ...
                  <div class="span3">
                    <figure>
						<img alt="" src="<?php echo INCLUDES ?>img/gallery/05rct-s.jpg">
                    </figure>
                    <h4>
                  ...
                  <div class="span3">
                    <figure>
						<img alt="" src="<?php echo INCLUDES ?>img/gallery/06rct-s.jpg">
                    </figure>
                    <h4>
