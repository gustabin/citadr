...
//===========================error si no escoge ningun horario ==========================
if ($dias==""){
	$data = array("error" => '1');
	...
	$dataHorario = mysql_fetch_array($query);	
	...
	if(empty($dataHorario))
		...
		$query = mysql_query("UPDATE tbl_horarios SET hor_lun='$horarioLun', hor_mar='$horarioMar', hor_mie='$horarioMie', hor_jue='$horarioJue', hor_vie='$horarioVie', hor_sab='$horarioSab', hor_dom='$horarioDom', hor_dias='$dias' WHERE hor_doc_id='$doc_id'");		
		}
